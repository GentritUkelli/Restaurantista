  ...
  pizza: [
    {
      ...
      price: 14.99,
      description:
        "Classic pizza topped with tomato sauce, mozzarello cheese and fresh meat.",
    ...
    },
    {
      ...
      price: 16.99,
      description:
        "Classic pizza topped with pepperoni, mozzarello cheese and fresh meat.",
    ...
    },
    {
      ...
      price: 15.99,
      description:
        "Classic pizza topped with pepperoni, mozzarello cheese and pineapple chunks.",
...
function calculateTotal() {
  ...
  basketItems.forEach((item) => {
    const itemPrice = parseFloat(item.querySelector("span:nth-child(2)").textContent);
    subTotal += itemPrice;
  });
